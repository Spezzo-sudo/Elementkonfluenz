...
- Python-Paket `elementkonfluenz_trend` (`elementkonfluenz_trend/`) ist gebaut und verifiziert:
  ...
  - `cli.py` — `python -m elementkonfluenz_trend.cli` (Einzel-Pick als `TopicBrief`-JSON)
